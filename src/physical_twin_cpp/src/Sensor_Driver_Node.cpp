...
#include <pigpio.h>
#include "include/PhysicalTwin_cpp/Device_Layer.hpp"
#include <ctime>
...
public: // Declares everything that follows as public
  ...
  t1(std::make_shared<std::string>("/sys/bus/w1/devices/28-0623c31c3ad6")), 
  t2(std::make_shared<std::string>("/sys/bus/w1/devices/28-0823c08d9067")),
  t3(std::make_shared<std::string>("/sys/bus/w1/devices/28-0923b0b407a7"))
